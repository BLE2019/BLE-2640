 ...
 */
xdc__META(__ASM__, "@(#)__ASM__ = C:/ti/simplelink/ble_sdk_2_02_01_18/examples/cc2650iot/2.5_sample_gpio_btninterrupt/iar/config/configPkg/package/cfg/app_ble_prm3");
