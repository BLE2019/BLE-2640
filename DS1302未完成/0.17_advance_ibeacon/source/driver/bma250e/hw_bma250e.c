...
bool BMA250E_GetData(void)
{
  ...
  ret = HwI2CGet(0x18,0x02, buffer, 7);
  ...
  Display_print3(dispHandle, 5, 0, "X:%d Y:%d Z:%d",buffer[1],buffer[3],buffer[5]);
  if((buffer[3]<(60+15)&&buffer[3]>(60-15))|(buffer[3]<(180+15)&&buffer[3]>(180-15)))bma_warn=0;
  else bma_warn=1;
  return ret;
}
/*********************************************************************
