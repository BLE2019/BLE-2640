...
extern uint8_t GetStartChannel(void);
/*!
 * ATTENTION: start channel MUST align to 8 for LoRaWAN specification
 */
#define LORA_CN470_START_CH                         GetStartChannel()//80
 ...
 * Minimal Tx output power that can be used by the node
 */
#define LORAMAC_MIN_TX_POWER                        TX_POWER_20_DBM//TX_POWER_2_DBM
