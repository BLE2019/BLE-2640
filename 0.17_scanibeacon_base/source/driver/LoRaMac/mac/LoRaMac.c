...
#include "../module/SchedTimer.h"
#include "../module/utilities.h"
    ...
    switch( macHdr.Bits.MType )
    {
        case FRAME_TYPE_JOIN_ACCEPT:
            ...
            if( micRx == mic )
            {
                ...
                LoRaMacParams.ReceiveDelay2 = LoRaMacParams.ReceiveDelay1 + (uint32_t)1e3;
            ...
            case SRV_MAC_RX_TIMING_SETUP_REQ:
                {
                    ...
                    LoRaMacParams.ReceiveDelay1 = (uint32_t)delay * (uint32_t)1e3;
                    LoRaMacParams.ReceiveDelay2 = LoRaMacParams.ReceiveDelay1 + (uint32_t)1e3;
...
LoRaMacStatus_t LoRaMacInitialization( LoRaMacPrimitives_t *primitives, LoRaMacCallback_t *callbacks )
{
    ...
    {
        Channels[i].Frequency = (uint32_t)(470.3e6 + (i + LORA_CN470_START_CH) * 200e3);
