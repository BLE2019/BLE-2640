...
{
    uint8_t rxbuf[1]={0}; 
    HwSPITrans(addr,buffer,rxbuf,size );
    
#if 0  //”¶÷ÿππ    
  uint8_t    i;

//    Trace_LoRaMac("SX1278WriteBuffer");
...
{
  uint8_t txbuf[1]= {0};
  HwSPITrans(addr,txbuf,buffer,size );
  
  #if 0 ///0709, ¥À¥¶”¶÷ÿππ
  uint8_t    i;

//   Trace_LoRaMac("SX1278ReadBuffer");
