...
*/
//typedef rtimer_clock_t    lora_clock_t; //0709
...
//bool SX1278WriteBuffer(uint8_t addr, uint8_t *buffer, uint8_t size);
//bool SX1278ReadBuffer(uint8_t addr, uint8_t *buffer, uint8_t size);
