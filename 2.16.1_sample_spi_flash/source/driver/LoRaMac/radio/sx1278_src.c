...
/*-------------------------------------------------------------------------*/
void SX1278ReadFifo(uint8_t *p_byBuf, uint8_t bySize)
{
...
{
    uint8_t tmp = 23;
    volatile uint8_t tmp2 = 10;
    volatile uint8_t tmp3 = 12;
    tmp = SX1278Read(REG_LR_OPMODE);
 //   DelayMs(1); 
    tmp2 = tmp & RF_OPMODE_MASK;    
    tmp3 = tmp2 |opMode;
    tmp3 = tmp3 |0x08;
    DelayMs(1);
    //SX1278WriteBuffer(REG_LR_OPMODE, (uint8_t*)&tmp3, 1);

    SX1278Write(REG_LR_OPMODE, tmp3);
...
//    temp = (uint8_t)((freq >> 16) & 0xFF );
//    temp1 = (uint8_t)((freq >> 8) & 0xFF);
//    temp2 = (uint8_t)(freq & 0xFF);
//    SX1278Write(REG_FRFMSB,0x75);
//    SX1278Write(REG_FRFMID,0xe0);
//    SX1278Write(REG_FRFLSB,0x00);
...
//    const uint8_t temp[] = {0x00,0x77,0x66,0x55,0x44,0x33,0x22,0x11,
//                             0x00,0x26,0x00,0x35,0x02,0x47,0x36,0x34,
//                             0x32,0x3a,0xa0,0x1e,0xa9,0x59,0x4b};
//    uint8_t tmp18 = temp[18];
...
//    memcpy((void*)p_byBuf,(void*)temp,23);
